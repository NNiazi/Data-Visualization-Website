...
var SyntheticData = /** @class */ (function () {
    function SyntheticData() {
        //Base URL of fixer.io API
        //https://min-api.cryptocompare.com/data/histominute?fsym=BTC&tsym=GBP&limit=10
        this.baseURL = "https://m3ijbzm7a4.execute-api.us-east-1.amazonaws.com/dev/";
    }
    //Returns a Promise that will get the exchange rates for the specified date
    SyntheticData.prototype.getSyntheticRates = function () {
        //Build URL for API call
        var url = this.baseURL + process.env.STUDENT_ID;
...
exports.SyntheticData = SyntheticData;
//Function downloads and outputs crypto data and then saves it to dynamoDB
function storeData() {
    return __awaiter(this, void 0, void 0, function () {
        var syntheticIo, result, resultArr, trimSynthetic, trimSyntheticTrain, promiseArray, databaseResult, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    syntheticIo = new SyntheticData();
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, syntheticIo.getSyntheticRates()];
                case 2:
                    result = _a.sent();
                    resultArr = result['data']['target'];
                    trimSynthetic = resultArr.splice(0, 100);
                    trimSyntheticTrain = resultArr.splice(100, 500);
                    ...
                    promiseArray = [];
                    trimSynthetic.forEach(function (data) {
